...
namespace credito_automotriz.Models
{
    public partial class automotrizContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("data source=PAULVELIZ-WINDO\\SQLEXPRESS01; Initial Catalog=automotriz; Integrated Security=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cliente>(entity =>
            {
                ...
                entity.HasOne(d => d.IdEstadoCivilNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Clientes__Id_est__2F10007B");
            });
            ...
            modelBuilder.Entity<EstadoCivil>(entity =>
            {
                ...
                entity.HasOne(d => d.IdHijosNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Estado_ci__Id_hi__300424B4");
            });
            ...
            modelBuilder.Entity<PlanSugerido>(entity =>
            {
                ...
                entity.HasOne(d => d.PlanFinanciamientoSugNavigation)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Plan_suge__Plan___30F848ED");
            });
