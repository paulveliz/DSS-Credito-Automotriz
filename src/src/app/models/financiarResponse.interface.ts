// To parse this data:
//
//   import { Convert, FinanciarResponse } from "./file";
//
//   const financiarResponse = Convert.toFinanciarResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface FinanciarResponse {
    valor_del_auto:       number;
    enganche:             number;
...
export class Convert {
    public static toFinanciarResponse(json: string): FinanciarResponse {
        return cast(JSON.parse(json), r("FinanciarResponse"));
    }

    public static financiarResponseToJson(value: FinanciarResponse): string {
        return JSON.stringify(uncast(value, r("FinanciarResponse")), null, 2);
    }
}
...
const typeMap: any = {
    "FinanciarResponse": o([
        { json: "valor_del_auto", js: "valor_del_auto", typ: 0 },
